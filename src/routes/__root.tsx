...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Senior Services Adult Family Home is a licensed adult family home in Mount Vernon, WA serving Skagit County — Burlington, Sedro-Woolley, Anacortes, and surrounding Washington communities. Private rooms, 24-hour care, dementia-friendly support." },
      ...
      { property: "og:description", content: "Licensed adult family home in Mount Vernon, WA serving Skagit County. Personalized senior care, private rooms, dementia support." },
          ...
          "@graph": [
            {
              ...
              description: "Licensed adult family home in Mount Vernon, WA providing personalized 24-hour senior care, private rooms, dementia support, and a true residential setting for up to six residents.",
              ...
              hasOfferCatalog: {
                ...
                itemListElement: [
                  { "@type": "Offer", itemOffered: { "@type": "Service", name: "Private Room Adult Family Home Care" } },
