  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Senior Services Adult Family Home" },
      {
        ...
        content:
          "Licensed Mount Vernon, WA adult family home with private bedrooms, personalized care, and a calm residential atmosphere.",
      },
  ...
  return (
    <>
      <section className="max-w-7xl mx-auto px-6 pt-16 lg:pt-24 pb-12">
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-16 items-end">
          <div>
            ...
            <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl mt-8 leading-[0.95]">
              A quieter way
              <br />
              to grow <em className="italic">older</em>,<br />
              at home.
            </h1>
            <p className="mt-8 text-lg text-[var(--hl-muted)] max-w-xl">
              Six private bedrooms. One caregiver to every three residents. Three home-cooked meals.
              A garden out back. We are small, on purpose.
            </p>
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                to={"/heirloom/tour" as any}
                className="px-7 py-3 text-white font-mono text-sm uppercase tracking-[0.18em]"
                style={{ background: "var(--hl-ink)" }}
              >
                Book a tour
              </Link>
              <Link
                to={"/heirloom/rooms" as any}
                className="px-7 py-3 font-mono text-sm uppercase tracking-[0.18em]"
                style={{ border: "1px solid var(--hl-ink)" }}
              >
                See bedrooms
              </Link>
            </div>
          ...
          <div className="text-right">
            ...
            <p className="font-mono text-xs uppercase tracking-widest text-[var(--hl-muted)] mt-2">
              bedrooms available
            </p>
          </div>
        </div>
        <img
          src={ASSETS.hero}
          alt="Heritage adult family home exterior with apple tree in the front yard"
          className="mt-16 w-full aspect-[21/9] object-cover"
          width={1600}
          height={700}
        />
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-x-10 gap-y-12">
          {VALUE_PROPS.map((v, i) => (
            <div key={v.title}>
              <p className="font-mono text-xs text-[var(--hl-primary)]">
      ...
      <section className="py-20" style={{ background: "var(--hl-surface)" }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-end justify-between flex-wrap gap-4 mb-12">
            ...
            <Link
              to={"/heirloom/services" as any}
              className="font-mono text-xs uppercase tracking-[0.18em] underline"
            >
              All services
            </Link>
          </div>
            ...
            {SERVICES.slice(0, 4).map((s, i) => (
              ...
              >
                <div className="flex items-baseline justify-between">
                  ...
                  <span className="font-mono text-xs text-[var(--hl-muted)]">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {rooms.slice(0, 3).map((r) => (
            <Link
              key={r.id}
              to={"/heirloom/rooms/$slug" as any}
              params={{ slug: r.slug } as any}
              className="block group"
            >
              <div className="aspect-[4/5] overflow-hidden">
                <img
                  src={r.photos[0] ?? ASSETS.room}
                  alt={r.name}
              ...
              <div className="flex items-baseline justify-between mt-4">
                ...
                <span className="font-mono text-xs text-[var(--hl-muted)] uppercase">
      ...
      <section className="py-20" style={{ background: "var(--hl-surface)" }}>
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="font-mono text-xs uppercase tracking-widest text-[var(--hl-muted)] mb-6">
            Indoor
          </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 bg-white" style={{ border: "1px solid var(--hl-border)" }}>
              ...
              <p className="mt-2 text-sm text-[var(--hl-muted)]">
                Outdoor entertainment &amp; performances
              </p>
            </div>
            <div className="p-6 bg-white" style={{ border: "1px solid var(--hl-border)" }}>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-block mt-6 font-mono text-xs uppercase tracking-[0.18em] underline"
        >
          Verify on DSHS
        </a>
      </section>
