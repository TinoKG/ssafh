...
export const Route = createFileRoute("/preview")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Internal design preview for Senior Services Adult Family Home.",
      },
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-6 py-20">
        <p className="text-xs uppercase tracking-[0.25em]" style={{ color: "#5B6351" }}>
          Design preview · Mount Vernon, WA
        </p>
        <h1
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="text-xs uppercase tracking-widest" style={{ color: "#3f6212" }}>
              Direction One
            </div>
            ...
            <p className="mt-3 text-sm" style={{ color: "rgba(28,25,23,0.7)" }}>
              Sage green, soft surfaces, gentle editorial layouts.
            </p>
            <span className="mt-6 inline-block text-sm font-medium" style={{ color: "#3f6212" }}>
              Open Heritage →
            </span>
          </Link>
          <Link
          ...
          >
            <div
              ...
              style={{ color: "#5B6351", fontFamily: "JetBrains Mono, monospace" }}
            >
              Direction Two
            </div>
            <h2 className="mt-2 text-3xl" style={{ fontFamily: "Lora, Georgia, serif" }}>
              Editorial <em>Heirloom</em>
            </h2>
            <p className="mt-3 text-sm" style={{ color: "rgba(45,42,38,0.7)" }}>
              Cream, serif headlines, mono labels.
            </p>
            <span className="mt-6 inline-block text-sm font-medium" style={{ color: "#5B6351" }}>
              Open Heirloom →
            </span>
          </Link>
        </div>
