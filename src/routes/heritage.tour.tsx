  ...
  head: () => ({
    meta: [
      { title: "Schedule a Tour — Adult Family Home in Mount Vernon, WA" },
      {
        name: "description",
        content:
          "Tour Senior Services Adult Family Home in Mount Vernon, WA. 45-minute in-person visit, no pressure. Serving Skagit County families.",
      },
...
const STEPS = [
  {
    n: "1",
    title: "Pick a time",
    body: "Tell us a day and time that works. We confirm within a few hours.",
  },
  {
    n: "2",
    title: "Visit",
    body: "Meet the owner and caregivers, see the rooms, and walk the garden.",
  },
  {
    n: "3",
    title: "Decide on your timeline",
    body: "No pressure. Take a few days. Talk it over with family.",
  },
];
  ...
  return (
    <div className="site-container section-y">
      ...
      <p className="mt-6 text-lg text-stone-600 max-w-2xl">
        Tours are calmest mid-morning, and we'll always offer coffee. Bring your questions.
      </p>

      <div
        className="mt-10 rounded-2xl overflow-hidden bg-stone-100"
      ...
      <div className="mt-12 grid lg:grid-cols-[1fr_1fr] gap-12">
          ...
          <ol className="mt-6 space-y-5">
            {STEPS.map((s) => (
              <li key={s.n} className="grid grid-cols-[40px_1fr] gap-4">
                <span
                  className="size-9 grid place-items-center rounded-full text-white font-display"
                ...
                <div>
                  ...
                  <p className="text-stone-600 text-sm mt-1">{s.body}</p>
                </div>
              </li>
            ))}
          </ol>
        ...
        <div
          className="p-8 rounded-2xl bg-white h-fit"
          style={{ border: "1px solid var(--h-border)" }}
        >
